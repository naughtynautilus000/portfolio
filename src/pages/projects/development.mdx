...
<span class="single-image w-1/2">![LeBron James item card](/portfolio/pages/development/item_card.png)</span>
...
<img src="/portfolio/pages/development/menu.png" alt="interface menu" class="absolute max-h-full w-auto"/>
</div>
